...
import {positions, normals, indices} from "../blender/Penuin.js"
...
const cubemap = app.createCubemap({
    negX: await loadTexture("Sky_bk.png"),
    posX: await loadTexture("Sky_ft.png"),
    negY: await loadTexture("Sky_dn.png"),
    posY: await loadTexture("stormydays_up.png"),
    negZ: await loadTexture("Sky_lf.png"),
    posZ: await loadTexture("Sky_rt.png")
});

let drawCall = app.createDrawCall(program, vertexArray)
    .texture("cubemap", cubemap);
    drawCall.uniform("objectColor", [2, 0.5, 1, 1.0]); // Example: Setting to red
